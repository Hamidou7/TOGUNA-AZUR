...
<body class="align">
    ...
    <div class="grid align__item" style="margin-top: 20px;">
        ...
        <div class="register">
            ...
            <p>Vous avez déjà un compte ? <a href="#">Connexion</a><br> <a href="{{ route('welcome')}}">Accueil</a></p>
